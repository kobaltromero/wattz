...
public class VisualAlternatorCrude extends KineticBlockEntityVisual<BEAlternatorCrude> {
    protected final RotatingInstance shaft;

    public VisualAlternatorCrude(VisualizationContext context, BEAlternatorCrude blockEntity, float partialTick) {
