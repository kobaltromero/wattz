...
public class VisualAlternator extends KineticBlockEntityVisual<BEAlternator> {
    protected final RotatingInstance shaft;

    public VisualAlternator(VisualizationContext context, BEAlternator blockEntity, float partialTick) {
